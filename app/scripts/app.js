...
angular.module('angularPressThemeApp', [
  ...
  .config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function ($stateProvider, $urlRouterProvider, $locationProvider) {
    ...
    .controller('LoginCtrl', ['$window', 'dataFactory', function($window, dataFactory) {
            ...
            dataFactory.getBlogInfo().then(function (data) {
                var url = data.url;
    ...
    .controller('MainCtrl', ['$scope', '$state', '$stateParams', 'dataFactory', '$q', function ($scope, $state, $stateParams, dataFactory, $q) {
        ...
        dataFactory.getMedia().then(function (data) {
            $scope.media = data;
        });
    ...
    .controller( 'CategoriesContent', ['$scope', '$rootScope', '$filter', 'dataFactory', 'categoryslug', function ($scope, $rootScope, $filter, dataFactory, categoryslug ) {
        ...
        dataFactory.getCategories().then(function (data) {
    ...
    .directive('singlePost', function () {
        return {
            ...
            controller:  function ($scope, $http) {
                ...
                $http.get('wp-json/wp/v2/posts?filter[name]=' + postSlug).then(function (res) {
                    $scope.post = res[0];
                });
            }
        };
    ...
    .directive('singlePage', function () {
        return {
            ...
            controller: function ($scope, $http ) {
                ...
                $http.get('wp-json/wp/v2/pages?filter[name]=' + pageSlug).then(function (res) {
                    $scope.page = res[0];
                });
            }
        };
    ...
    .directive('postsByCategory', function () {
        return {
            ...
            controller:['$scope', '$http', function ($scope, $http) {
                ...
                $http.get('wp-json/wp/v2/posts?filter[category_name]=' + category_slug).then(function (res) {
        ...
        return {
            ...
            controller: ['$http', '$scope', function ( $http, $scope) {
                ...
                if ( mediaId != 0 && !mediaSize) {
                    $http.get('wp-json/wp/v2/media/' + mediaId).then(function(data){
...
////            }
        ...
        return {
            ...
            controller: ['$scope', '$http', function ($scope, $http) {
                ...
                $scope.search = function () {
                        $http.get('wp-json/wp/v2/posts/?filter[s]=' + $scope.filter.s).then(function (data) {
                            $scope.posts = data;
                        });
                };
        ...
        return {
            ...
            controller: ['$scope', '$http', function ($scope, $http) {
                ...
                $scope.searchsidebar = function () {
                        ...
                        $http.get('wp-json/wp/v2/posts/?filter[s]=' + $scope.filtersidebar.s).then(function (data) {
                            $scope.postsinsidebar = data;
                        });

                        $http.get('wp-json/wp/v2/media').then(function(data){
    ...
    .directive('mainSidebar', function () {
        return {
            ...
            controller: ['$scope', 'dataFactory', function ($scope, dataFactory) {
                ...
                dataFactory.getWidgetMainSidebar().then(function (data) {
    ...
    .directive('footerSidebarLeft', function () {
        return {
            ...
            controller: ['$scope', 'dataFactory', function ($scope, dataFactory) {
                dataFactory.getWidgetFooterSidebarLeft().then(function (data) {
    ...
    .directive('footerSidebarRight', function () {
        return {
            ...
            controller: ['$scope', 'dataFactory', function ($scope, dataFactory) {
                ...
                dataFactory.getWidgetFooterSidebarRight().then(function (data) {
...
.directive('mobileSidebar', function () {
    ...
    .directive('headerMenu', function () {
        return {
            ...
            controller: ['$scope', 'dataFactory', function ($scope, dataFactory) {
                dataFactory.getHeaderMenu().then(
                  function (response) {
                    $scope.headerMenu = response.data;
                }, function (error) {
                  console.log ( error );
                });
            }]
    ...
    .directive('headerMenuMobile', function () {
        return {
            ...
            controller: ['$scope', 'dataFactory', function ($scope, dataFactory) {
                dataFactory.getHeaderMenu().then(function (data) {
    ...
    .directive('footerMenu', function () {
        return {
            ...
            controller: ['$scope', 'dataFactory', function ($scope, dataFactory) {
                dataFactory.getFooterMenu().then(function (data) {
